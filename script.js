...
class CVStrategiesFooter extends HTMLElement {
    ...
    render() {
        this.shadowRoot.innerHTML = `
            ...
            <div id="cv-strategies-footer-wrapper" style="font-size: ${this.getFontSize()}; text-align: ${this.getTextAlign()}; margin: 0; padding-bottom: 10px; width: 100%;">
    ...
    getFontSize() {
        return this.getAttribute('font-size')?.trim() ?? '1rem';
    }
